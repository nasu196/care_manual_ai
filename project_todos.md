...
| No.8 AIチャットボットインターフェース実装        | AI/USER   |      | 完了(v2.1) | 基本的なQ&A表示、Markdownレンダリング対応。チャットエリアのスクロール制御改善、AI回答の詳細度設定機能(UI)追加、吹き出し幅調整、NotebookLM風ヘッダー追加に伴うレイアウト調整。**選択ソースによるチャット参照範囲の制御機能を追加。** |
| 管理者作成メモ閲覧機能実装                     |           |      | 未着手   |                                                            |
...
| 管理者作成メモ作成・編集・管理機能実装                       | AI/USER |      | 進行中   |                                          |
